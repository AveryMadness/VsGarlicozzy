...
class Achievements {
	public static var achievementsStuff:Array<Dynamic> = [ //Name, Description, Achievement save tag, Hidden achievement
		...
		["Blimey",						"Beat The Garlicozzy Week on Hard with no Misses.",	'weekg_nomiss',			false],
		...
		["Cheater",						"Beat Cheating. How.",								'cheater',				 true],
		["True Cheater",				"Beat Unfairness. What The Fuck.",					'truecheater',			 true],
		["What The Fuck",				"Beat Unfairness B-Side. Seriously. What The Fuck.","whatthefuck",			 true]
	];
